...
module.exports = function ($app) {
     ...
     *
     */
    $app.directive("ysFrameworkDropdown", ["$timeout", function ($timeout) {
        return {
            controller: ["$scope", "$q", "$compile", "$element", "$attrs", function (_$scope, $q, $compile, $element, $attrs) {
                var $container = $app.$(require("../views/dropdown.html")),
                    ...
                    }, $scope.$eval($attrs.ysFrameworkDropdown)),
                ...
                // 显示 与 隐藏 dropdown
                $container.on("click", ".ys-framework-dropdown-toggle", function () {
                    $app.$("div.ys-framework-dropdown").not($container).removeClass("open")
                    $container.toggleClass("open");
                    if ($container.hasClass("open")) {
                        $container.find(".ys-framework-dropdown-search input").trigger("focus");
                        $app.el.body.one("click", function () {
                            $container.removeClass("open");
                        })
                    }
                });
                $container.find("input.ys-framework-dropdown-text").width(option.width);
