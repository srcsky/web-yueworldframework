        ...
        return (function ($rootScope, $animate, $q, $timeout, $compile, $controller) {
            var $backdrop = $app.backdrop(),
                ...
                option = $scope.option = angular.extend({
                    resolve: {}, controller: [angular.noop], width: 600, deferred: $q.defer()
                }, $option);
            ...
            var locals = angular.extend({$element: $container}, option.resolve, {$scope: angular.extend($scope.$new(), option)});
            try {
